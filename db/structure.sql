...
--
-- Name: departure_matrices; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE departure_matrices (
    id integer NOT NULL,
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL
);
...
--
-- Name: departure_matrices_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE departure_matrices_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: departure_matrices_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE departure_matrices_id_seq OWNED BY departure_matrices.id;
...
ALTER TABLE ONLY departure_matrices ALTER COLUMN id SET DEFAULT nextval('departure_matrices_id_seq'::regclass);
...
--
-- Name: departure_matrices_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY departure_matrices
    ADD CONSTRAINT departure_matrices_pkey PRIMARY KEY (id);
