...
ActiveRecord::Schema.define(version: 20170202110539) do
  ...
  create_table "carriers", force: :cascade do |t|
    ...
    t.datetime "created_at",            null: false
    t.datetime "updated_at",            null: false
    t.index ["code"], name: "index_carriers_on_code", unique: true, using: :btree
  end

  create_table "departure_matrices", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "departures", force: :cascade do |t|
    ...
    t.datetime "created_at",                    null: false
    t.datetime "updated_at",                    null: false
    t.index ["cancelled"], name: "index_departures_on_cancelled", using: :btree
    t.index ["dest"], name: "index_departures_on_dest", using: :btree
    t.index ["origin"], name: "index_departures_on_origin", using: :btree
    t.index ["unique_carrier"], name: "index_departures_on_unique_carrier", using: :btree
    t.index ["year"], name: "index_departures_on_year", using: :btree
  end
